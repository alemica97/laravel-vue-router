...
var render = function () {
  ...
  return _c("div", { staticClass: "post-card" }, [
    ...
    _c("div", { staticClass: "post-card-body" }, [
      _c("h3", { staticClass: "post-card-title" }, [
        _vm._v(_vm._s(_vm.post.title)),
      ]),
      _vm._v(" "),
      _vm.post.category
        ? _c("span", { staticClass: "post-card-category" }, [
            _vm._v(
      ...
      _c(
        ...
        _vm._l(_vm.post.tags, function (tag) {
          return _c("li", { key: tag.id, staticClass: "post-card-tag" }, [
            _c("span", { staticClass: "post-tag" }, [_vm._v(_vm._s(tag.name))]),
          ])
        }),
        0
      ),
